...
#
# Created: Thu Apr 12 11:50:09 2018
...
class Ui_AGTMagDialog(object):
    def setupUi(self, AGTMagDialog):
        ...
        self.groupBox_5 = QtGui.QGroupBox(AGTMagDialog)
        ...
        self.inFileLine = QtGui.QLineEdit(self.groupBox_5)
        ...
        self.ButtonBrowse = QtGui.QPushButton(self.groupBox_5)
        ...
        self.gridLayout.addWidget(self.label_georefscr, 1, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.datFilechkbox, 2, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.coordFieldschk, 2, 4, 1, 2)
        ...
        self.gridLayout.addWidget(self.comboCRS, 1, 3, 1, 3)
        ...
        self.RawDecimRadioBut = QtGui.QRadioButton(self.groupBox_4)
        self.RawDecimRadioBut.setObjectName(_fromUtf8("RawDecimRadioBut"))
        self.horizontalLayout_2.addWidget(self.RawDecimRadioBut)
        self.MedianDecimRadioBut = QtGui.QRadioButton(self.groupBox_4)
        self.MedianDecimRadioBut.setChecked(True)
        self.MedianDecimRadioBut.setObjectName(_fromUtf8("MedianDecimRadioBut"))
    ...
    def retranslateUi(self, AGTMagDialog):
        AGTMagDialog.setWindowTitle(_translate("AGTMagDialog", "MXPDA processing - GNSS", None))
        ...
        self.label_georefscr.setText(_translate("AGTMagDialog", "Export CRS projection", None))
        ...
        self.groupBox_4.setTitle(_translate("AGTMagDialog", "Decimation", None))
        self.RawDecimRadioBut.setText(_translate("AGTMagDialog", "Raw", None))
        self.MedianDecimRadioBut.setText(_translate("AGTMagDialog", "Moving median", None))
        ...
        self.label_8.setText(_translate("AGTMagDialog", "GNSS located on probe", None))
